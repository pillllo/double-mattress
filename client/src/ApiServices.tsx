...
function getProjections(body:any) {
  return fetchRequest("/projections", {
      ...
      headers: {
          "Content-Type": "application/json",
          "Client-Jwt": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjb2Rld29ya3Mtc2VuaW9yIiwibmFtZSI6ImRvdWJsZS1tYXR0cmVzcy1zZXJ2ZXIiLCJpYXQiOjE1MTYyMzkwMjJ9.V-deQaQW6rBJjQBVzWW7B1_jPenmrtUWXGxKT1CCUyY"
      },
      body: JSON.stringify(body)
  });
}
